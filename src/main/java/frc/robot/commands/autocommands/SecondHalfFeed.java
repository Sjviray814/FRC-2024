...
public class SecondHalfFeed extends ParallelDeadlineGroup {

  /** Creates a new StupidDriveOut. */
  public SecondHalfFeed(Intake intake, Shooter shooter) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        new IntakeToAngle(intake, 0),
        new OscillateFeeder(shooter)
    );
  }
}
